...
for i in range(1,8):
    # read data
    num_classes = 2
    data = loadmat('Documents/ADT-Filter-in-Shadow-Detection/ADT/cross validation/'+str(i)+'/Ttraindata.mat',)
    x_train = data['Ttraindata']
    y_train = data['TtrainLabel']
    testdata = loadmat('Documents/ADT-Filter-in-Shadow-Detection/ADT/cross validation/1/Ttestdata.mat')

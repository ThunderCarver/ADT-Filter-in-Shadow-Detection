...
mlp10pos = patternnet(hiddenLayerSize);
mlp10pos.layers{1}.transferFcn='poslin';  %set activation function of first layer
% Setup Division of Data for Training, Validation, Testing
mlp10pos.divideParam.trainRatio = 70/100;
mlp10pos.divideParam.valRatio = 15/100;
mlp10pos.divideParam.testRatio = 15/100;

% Train the Network
[mlp10pos,tr] = train(mlp10pos,x,t);
% View the Network
%view(mlp1net)
...
y=mlp10pos(x);
e=gsubtract(t,y);
performance=perform(mlp10pos,t,y);
tind=vec2ind(t);
yind=vec2ind(y);
...
save mlp10posmodel.mat mlp10pos
